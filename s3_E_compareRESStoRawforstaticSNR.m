...
job.crunchandplotppantstatSNR=1; % per ppant, using BG freqs to check for changes.


job.concatacrossppants=1;

job.plotacrossppants=1; %paper figure?
job.exportforJASP=1; % for stats.

job.checkPFIsubtractCATCH=1;
...
windowsmall=[];
windowsmall(1,:) = [-3 -1] ;% longer window targets present
